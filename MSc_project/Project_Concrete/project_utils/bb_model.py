    ...
    def __init__(self,
        ...
        if dataset == 'Boston':
            ...
            self.feature_names = ['crime_rate','zoned_lots','industry','by_river','NOX','avg_rooms','pre_1940',
                                 'emp_distance','rad_access','tax_rate','pupil_tea_rat','bk','low_status']

            self.outcome = 'median_value'
            
            self.catagorical_features = [3, 9]
            
            self.Read_File('datasets/boston.csv')
        ...
        ################################################################################################################
            ...
            self.feature_names = ['cement','slag','flyash','water','superplasticizer','coarseaggregate','fineaggregate','age']

            self.outcome              = 'csMPa'
            self.catagorical_features = []
            
            self.Read_File('datasets/Concrete_Data_Yeh.csv')
